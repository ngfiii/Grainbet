      ...
      <div className="p-2 md:p-4 border-b border-gray-700 flex items-center justify-between">
        ...
        {collapsed && (
          <img
            ...
            src="https://i.imgur.com/p9vMbEB.png"
          />
        )}
        <Button
          onClick={onToggle}
          variant="ghost"
          size="sm"
          className="text-gray-400 hover:text-white hover:bg-gray-700 flex-shrink-0 p-1 md:p-2"
        >
          {collapsed ? '→' : '←'}
        </Button>
      </div>
      ...
      <div className="flex-1 p-1 md:p-2 space-y-1 overflow-y-auto">
        {games.map((game) => (
          <Button
            ...
            className={cn(
              "w-full justify-start font-mono transition-all duration-200 text-sm md:text-base",
              currentGame === game.id
                ? "bg-yellow-600 text-black hover:bg-yellow-700"
                : "text-gray-300 hover:text-white hover:bg-gray-700",
              collapsed ? "px-1 md:px-2" : "px-2 md:px-4",
        ...
        {user && (
          <Button
            ...
            variant="ghost"
            className={cn(
              "w-full justify-start font-mono transition-all duration-200 text-blue-400 hover:text-white hover:bg-blue-700/20 text-sm md:text-base",
              collapsed ? "px-1 md:px-2" : "px-2 md:px-4",
              "min-h-[40px] md:min-h-[44px]"
            )}
          >
        ...
        <Button
          ...
          variant="ghost"
          className={cn(
            "w-full justify-start font-mono transition-all duration-200 text-yellow-400 hover:text-white hover:bg-yellow-700/20 text-sm md:text-base",
            collapsed ? "px-1 md:px-2" : "px-2 md:px-4",
            "min-h-[40px] md:min-h-[44px]"
          )}
        >
        ...
        <Button
          ...
          variant="ghost"
          className={cn(
            "w-full justify-start font-mono transition-all duration-200 text-red-400 hover:text-white hover:bg-red-700/20 text-sm md:text-base",
            collapsed ? "px-1 md:px-2" : "px-2 md:px-4",
            "min-h-[40px] md:min-h-[44px]"
          )}
        >
