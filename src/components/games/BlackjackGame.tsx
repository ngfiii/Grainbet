                  ...
                  {dealerHand.map((card, index) => (
                    ...
                    >
                      ...
                      {index === 1 && !showDealerSecondCard ? (
                        ...
                        <div
                          className={`bg-white text-black border-2 p-4 rounded-lg text-3xl font-bold min-w-[80px] h-[120px] flex flex-col items-center justify-center shadow-lg transition-all duration-300 hover:scale-105 ${
