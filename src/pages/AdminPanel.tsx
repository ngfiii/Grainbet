...
const AdminPanel = () => {
  ...
  const deleteKeysByAmount = async (amount: number) => {
    ...
    if (error) {
      ...
      toast.success(`Deleted all unused ${amount} coin keys`);
      fetchCoinKeys();
    }
  };
  ...
  return <div className="min-h-screen bg-gray-900 text-white p-2 md:p-4 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-4 md:space-y-6">
        ...
        <Tabs defaultValue="keys" className="w-full">
          ...
          <TabsContent value="users" className="space-y-4 md:space-y-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent>
                <p className="text-gray-400 font-mono text-xs md:text-sm">User management features coming soon...</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="tools" className="space-y-4 md:space-y-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent>
                <p className="text-gray-400 font-mono text-xs md:text-sm">Additional admin tools coming soon...</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            <CardTitle className="text-purple-400 font-mono text-sm md:text-base">Statistics</CardTitle>
          </CardHeader>
          <CardContent>
